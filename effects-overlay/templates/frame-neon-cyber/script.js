(function () {
  ...
  var animationClasses = ['kh-anim-slide-up', 'kh-anim-slide-left', 'kh-anim-scale-in', 'kh-anim-none'];
  ...
  window.KomehubTemplateRuntime.htmlFirst.start({
    ...
    config: {
      callbacks: {
        kickerText: function (value) { setText('.frame-kicker', value, 'CYBER'); },
        headerText: function (value) { setText('.frame-title', value, 'NEXUS-77'); },
        footerText: function (value) { setText('.frame-footer-text', value, 'node://komehub'); },
